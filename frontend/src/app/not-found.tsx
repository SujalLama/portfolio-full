...
export default function NotFound() {
  return (
    <div className="w-screen h-screen justify-center flex flex-col items-center dark:bg-primary">
        ...
        <Link href="/" className="mt-16 text-white bg-secondary hover:scale-105 transition focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2
